...
def hard_test_dynasig():
    ...
    dsml_model = DynaSigML_Model("combined_dsdf.pickle", test_ids=test_ids, train_ids=train_ids, verbose=True,
                                 predictor_columns=['mcfold_energy'],
    ...
    dsml_model.save_to_file('dsml_model_hard_deltaG')
    dsml_model.make_graphs('graphs_hard_deltaG')
...
def inverted_test_dynasig():
    ...
    dsml_model.train_test_ml_models()
    dsml_model.performance_report()
    dsml_model.save_to_file('dsml_model_inverted_deltaG')
    dsml_model.make_graphs('graphs_inverted_deltaG')
